-- Migration: Create tables after ENUMs are committed
-- This migration creates all tables using the ENUMs created in the previous migration
-- ENUMs must be committed before they can be safely used in table definitions

-- SAFETY CHECK: Ensure ENUMs exist before creating tables
-- This is a fallback in case the previous migration wasn't executed
...
-- PHASE 3: Create core tables in dependency order
-- 1. Independent tables first

-- admin_users table
CREATE TABLE IF NOT EXISTS treinamento.admin_users (
...
-- courses table
CREATE TABLE IF NOT EXISTS treinamento.courses (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  name TEXT NOT NULL,
  description TEXT,
...
CREATE TABLE IF NOT EXISTS treinamento.course_position_access (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- unidades table
CREATE TABLE IF NOT EXISTS treinamento.unidades (
  id TEXT PRIMARY KEY,
  id_matriz UUID,
...
-- users table
CREATE TABLE IF NOT EXISTS treinamento.users (
  id UUID PRIMARY KEY,
  name TEXT NOT NULL,
  email TEXT UNIQUE,
...
-- turmas table
CREATE TABLE IF NOT EXISTS treinamento.turmas (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  name TEXT NOT NULL,
  code TEXT UNIQUE,
  course_id UUID NOT NULL,
...
-- enrollments table
CREATE TABLE IF NOT EXISTS treinamento.enrollments (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  course_id UUID NOT NULL,
  turma_id UUID,
  user_id UUID,
...
-- lessons table
CREATE TABLE IF NOT EXISTS treinamento.lessons (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  course_id UUID NOT NULL,
  turma_id UUID,
  title TEXT NOT NULL,
...
-- attendance table
CREATE TABLE IF NOT EXISTS treinamento.attendance (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- certificates table
CREATE TABLE IF NOT EXISTS treinamento.certificates (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  course_id UUID NOT NULL,
  enrollment_id UUID NOT NULL,
  turma_id UUID,
...
CREATE TABLE IF NOT EXISTS treinamento.collaboration_approvals (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- 2. Supporting and feature tables

-- automated_lesson_dispatches table
CREATE TABLE IF NOT EXISTS treinamento.automated_lesson_dispatches (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  lesson_id UUID NOT NULL,
  turma_id UUID,
...
CREATE TABLE IF NOT EXISTS treinamento.class_audit_logs (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- classes table
CREATE TABLE IF NOT EXISTS treinamento.classes (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  course_id UUID NOT NULL,
  name TEXT NOT NULL,
  description TEXT,
...
-- job_positions table
CREATE TABLE IF NOT EXISTS treinamento.job_positions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS treinamento.kanban_columns (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS treinamento.lesson_sessions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  lesson_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS treinamento.live_participants (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  lesson_id UUID NOT NULL,
  user_id UUID NOT NULL,
...
-- modules table
CREATE TABLE IF NOT EXISTS treinamento.modules (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS treinamento.password_sync_queue (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS treinamento.professor_permissions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS treinamento.professor_turma_permissions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  professor_id UUID NOT NULL,
...
-- profiles table
CREATE TABLE IF NOT EXISTS treinamento.profiles (
  id UUID PRIMARY KEY,
  full_name TEXT,
  avatar_url TEXT,
  website TEXT,
...
-- quiz table
CREATE TABLE IF NOT EXISTS treinamento.quiz (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  course_id UUID NOT NULL,
  turma_id UUID,
  title TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS treinamento.quiz_responses (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS treinamento.recorded_lessons (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  lesson_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS treinamento.student_classes (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  class_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS treinamento.student_progress (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL,
  course_id UUID NOT NULL,
  lesson_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS treinamento.sync_audit_log (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS treinamento.system_settings (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- tests table
CREATE TABLE IF NOT EXISTS treinamento.tests (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  course_id UUID NOT NULL,
  turma_id UUID,
  title TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS treinamento.test_questions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS treinamento.test_question_options (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS treinamento.test_submissions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  test_id UUID NOT NULL,
  user_id UUID NOT NULL,
  enrollment_id UUID,
...
CREATE TABLE IF NOT EXISTS treinamento.test_responses (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS treinamento.transformation_kanban (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  course_id UUID NOT NULL,
  turma_id UUID,
...
CREATE TABLE IF NOT EXISTS treinamento.whatsapp_dispatches (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID,
  phone TEXT NOT NULL,
...
-- Migration completed successfully - Tables created with ENUMs