...
import { useTestQuestions, useUpdateQuestion } from "@/hooks/useTestQuestions";
...
const EditQuestionDialog = ({ testId, questionId, open, onOpenChange }: EditQuestionDialogProps) => {
  ...
  // Reset form when question data changes
  useEffect(() => {
    if (question) {
      form.reset({
